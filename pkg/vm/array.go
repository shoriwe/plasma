...
func (p *Plasma) NewArray(context *Context, isBuiltIn bool, parentSymbols *SymbolTable, content []Value) *Array {
	array := &Array{
		Object: p.NewObject(context, isBuiltIn, ArrayName, nil, parentSymbols),
	}
						...
						func(self Value, arguments ...Value) (Value, *Object) {
							...
							for i := 0; i < self.GetLength(); i++ {
								...
								if getError != nil {
									...
									if getError != nil {
										return nil, p.NewObjectWithNameNotFoundError(context, right.GetClass(p), RightEquals)
									}
						...
						func(self Value, arguments ...Value) (Value, *Object) {
							...
							for _, tupleValue := range self.GetContent() {
								...
								if _, ok := callResult.(*Bool); ok {
									...
									if getError != nil {
										return nil, p.NewObjectWithNameNotFoundError(context, callError.GetClass(p), ToBool)
									}
				...
				return p.NewFunction(context, isBuiltIn, object.SymbolTable(),
					NewBuiltInClassFunction(object, 0,
						func(self Value, _ ...Value) (Value, *Object) {
							...
							return p.NewArray(context, false, context.PeekSymbolTable(), copiedObjects), nil
						},
					),
				)
			},
					...
					NewBuiltInClassFunction(object, 1,
						func(self Value, arguments ...Value) (Value, *Object) {
							...
							if _, ok = indexObject.(*Integer); ok {
								...
								return p.NewArray(context, false, context.PeekSymbolTable(), self.GetContent()[startIndex:targetIndex]), nil
							} else {
				...
				return p.NewFunction(context, isBuiltIn, object.SymbolTable(),
					NewBuiltInClassFunction(object, 2,
						func(self Value, arguments ...Value) (Value, *Object) {
							...
							if calcError != nil {
								return nil, p.NewIndexOutOfRange(context, self.GetLength(), arguments[0].GetInteger())
							}
