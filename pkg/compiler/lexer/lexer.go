...
func guessKind(buffer []rune) (Kind, DirectValue) {
...
func (lexer *Lexer) tokenizeChars(startingChar rune) ([]rune, Kind, DirectValue, *errors.Error) {
...
func (lexer *Lexer) tokenizeNotRepeatableOperator(char rune,
